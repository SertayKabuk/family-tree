...
-- CreateEnum
CREATE TYPE "StoryStatus" AS ENUM ('PENDING', 'GENERATING', 'COMPLETED', 'FAILED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Story_memberId_key" ON "Story"("memberId");

-- CreateIndex
CREATE INDEX "Story_memberId_idx" ON "Story"("memberId");
...
-- AddForeignKey
ALTER TABLE "Story" ADD CONSTRAINT "Story_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "FamilyMember"("id") ON DELETE CASCADE ON UPDATE CASCADE;
