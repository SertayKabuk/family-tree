...
export async function GET(
  ...
  try {
    ...
    if (rangeHeader) {
      ...
      return new NextResponse((chunk.buffer as ArrayBuffer).slice(chunk.byteOffset, chunk.byteOffset + chunk.byteLength), {
    ...
    return new NextResponse((fileBuffer.buffer as ArrayBuffer).slice(fileBuffer.byteOffset, fileBuffer.byteOffset + fileBuffer.byteLength), {
      headers: {
        "Content-Type": mimeType,
